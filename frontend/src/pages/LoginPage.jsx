    ...
    <div className="min-h-screen pt-24 pb-12 flex items-center justify-center relative z-10">
      ...
      >
        <div className="text-center mb-8">
          <h2 className="text-3xl font-playfair font-bold text-mystic-gold mb-2">Chào mừng trở lại</h2>
          <p className="text-gray-300">Đăng nhập để xem lịch sử trải bài của bạn</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-400">
            Chưa có tài khoản?{' '}
            <Link to="/register" className="font-medium text-mystic-gold hover:text-yellow-400 transition-colors">
              Đăng ký ngay
            </Link>
          </p>
        </div>
