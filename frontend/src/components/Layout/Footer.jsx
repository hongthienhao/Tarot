...
const Footer = () => {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-20">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-6">
              <motion.a whileHover={{ y: -5, color: '#d4af37' }} href="#" onClick={(e) => e.preventDefault()} className="text-gray-500 transition-colors flex items-center gap-2">
            ...
            <ul className="space-y-4 text-sm text-gray-400 font-light">
              <li>
                <a 
                  ...
                  className="hover:text-mystic-gold transition-colors cursor-pointer"
                >
                  Trang chủ
                </a>
              </li>
              <li>
                <a 
                  href="#spreads" 
                  onClick={(e) => handleSmoothScroll(e, 'spreads')} 
                  className="hover:text-mystic-gold transition-colors cursor-pointer"
                >
                  Kiểu trải bài
                </a>
              ...
              <li>
                <button 
                  ...
                  className="hover:text-mystic-gold transition-colors cursor-pointer text-left block w-full bg-transparent border-none p-0 focus:outline-none"
                >
                  Ý nghĩa bài
                </button>
              </li>
              <li>
                <span className="text-gray-600 transition-colors cursor-not-allowed select-none italic text-xs">
                  Cửa hàng (Sắp ra mắt)
                </span>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400 font-light">
              <li><a href="#" onClick={(e) => e.preventDefault()} className="hover:text-mystic-gold transition-colors">Câu hỏi thường gặp</a></li>
              <li><a href="#" onClick={(e) => e.preventDefault()} className="hover:text-mystic-gold transition-colors">Chính sách bảo mật</a></li>
              <li><a href="#" onClick={(e) => e.preventDefault()} className="hover:text-mystic-gold transition-colors">Điều khoản dịch vụ</a></li>
              <li><a href="#" onClick={(e) => e.preventDefault()} className="hover:text-mystic-gold transition-colors">Liên hệ</a></li>
            </ul>
          </div>
        </div>
      ...
      {/* Embedded Public Dictionary Modal */}
